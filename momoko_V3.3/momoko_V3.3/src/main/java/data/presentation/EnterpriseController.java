...
import data.presentation.util.PaginationHelper;
import data.persistence.EnterpriseFacade;
import data.presentation.util.lazymodels.LazyEnterpriseDataModel;
...
public class EnterpriseController implements Serializable {
    ...
    private LazyEnterpriseDataModel lazyModel;
    @EJB
    private data.persistence.EnterpriseFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Enterprise) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EnterpriseCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EnterpriseUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("EnterpriseDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Enterprise getEnterprise(java.lang.Long id) {
