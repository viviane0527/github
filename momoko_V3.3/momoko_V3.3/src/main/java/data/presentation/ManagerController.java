...
import data.presentation.util.lazymodels.LazyAccountDataModel;
import data.presentation.util.lazymodels.LazyManagerDataModel;
...
public class ManagerController implements Serializable {
    ...
    private LazyManagerDataModel lazyModel;
    
    @EJB
    private data.persistence.ManagerFacade ejbFacade;
    ...
    public ManagerController() {
        ...
        public LazyDataModel<Manager> getLazyModel(){
        return lazyModel;
    }
